...
namespace EduJournal.DAL.Migrations
{
    ...
    [Migration("20201129145008_AddJournalRecordsConstraints")]
    partial class AddJournalRecordsConstraints
    {
            ...
            modelBuilder.Entity("EduJournal.DAL.Entities.JournalRecord", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_JournalRecords_Score", "[Attendance] = 0 AND [Score] = 0 OR [Attendance] = 1 AND [Score] BETWEEN 1 AND 5");
                });
